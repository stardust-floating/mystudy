import tpl0 from './tpl/index0.tpl';
import tpl1 from './tpl/index1.tpl';
import tpl2 from './tpl/index2.tpl';
import tpl3 from './tpl/index3.tpl';
...
export default {
    ...
    bindEvent(oList, setCurrentNews) {
        oList.addEventListener('click', this._goToDetail.bind(this, setCurrentNews));
    },
